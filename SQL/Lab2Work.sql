...
/*Select dvdactor.first_name, dvdfilm.title
From dvdactor, dvdfilm, dvdfilm_actor
Where dvdactor.actor_id = dvdfilm_actor.actor_id and dvdfilm_actor.film_id = dvdfilm.film_id and dvdactor.last_name = 'Willis';*/
